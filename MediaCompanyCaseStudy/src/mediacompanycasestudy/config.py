...
serialization_dataframe = Configurations.__call__().get_configuration()['serialisation']['dataframe']
serialization_model1 = Configurations.__call__().get_configuration()['serialisation']['model1']
serialization_model2 = Configurations.__call__().get_configuration()['serialisation']['model2']
...
# fig reports
fig_path = Configurations.__call__().get_configuration()['reports']['fig_path']