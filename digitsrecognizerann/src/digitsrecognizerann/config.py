...
# ann dimensions
dimensions_test = [int(x) for x in
                   Configurations.__call__().get_configuration()['anndimensions']['dimensions_test'].split(',')]
dimensions_nn = [int(x) for x in
                 Configurations.__call__().get_configuration()['anndimensions']['dimensions_nn'].split(',')]
